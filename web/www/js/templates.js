...
loginView +='<div id="login-ingreso">'+
				'<div id="login-ingreso-contenedor">'+
					'<i class="fa fa-user" aria-hidden="true" id="fontAwesome"></i><input type="text" id="usuario" placeholder="Usuario">'+
				'</div>'+
				'<div id="login-ingreso-contenedor">'+
					'<i class="fa fa-lock" aria-hidden="true" id="fontAwesome"></i><input type="password" id="contrasenia" placeholder="Contrase&ntilde;a">'+
				'</div>'+
				'<div id="login-ingreso-contenedor">'+
				'</div>'+
			'</div>';
